+++
title = "GMTK25 - Built to Scale"
description = "My submission for the GMTK25 game jam"
[extra]
status = ""
languages = "C#"
technologies = "Unity"
image_url = "images/scale-the-kittadel.png"
image_alt = "gmtk24-alt"
link = "https://anonyym0us.itch.io/reach-the-kittadel"
+++
...
The player (the wizard cat) is constantly moving upwards, and as they travel, various obstacles fall towards them. They have to dodge the obstacles, while getting as high as possible up the tower.
It is probably good to note that they can move up and down on the screen - movement is not contrained to 1 axis.

As they fly, they will come across powerups - which will present them with two possible stat improvements.
One example would be the choice between a +5% to max mana, mana reacharge, and health, or a +3% to max health, and a new spell.

Speaking of spells, there are 4, and you choose 1 when you start. The options are a heal, a teleport, a black hole (sucks obstacles towards it), and a movementspeed buff.
